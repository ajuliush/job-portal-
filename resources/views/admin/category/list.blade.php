                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="fs-4 mb-1">Job Category</h3>
                            </div>
                            <div style="margin-top: -10px;">
                                <a href="{{route('admin.createCategory')}}" class="btn btn-info"> Add Category</a>
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="action-dots ">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" onclick="deleteJobCategory({{ $category->id }})" href="javascript:void(0);"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
