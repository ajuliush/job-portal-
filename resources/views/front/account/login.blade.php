...
<script>
    const adminEmail = "aschuster@example.org"; // Replace with actual admin email
    const adminPassword = "password"; // Replace with actual admin password

    const userEmail = "benton06@example.org"; // Replace with actual user email
    const userPassword = "password"; // Replace with actual user password
